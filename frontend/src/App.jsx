            ...
            >
                <Box px={"0.6rem"}>
                    <IconButton
                        ...
                        bgColor={selected && "rgba(255,255,255,0.85)"}
                    >
                        {icon}
                    </IconButton>
                </Box>
    ...
    return (
        ...
        >
            ...
            <SidebarButton
                ...
                selected={window.location.pathname == "/app/home"}
            />
            <SidebarButton
                icon={<CalendarDays />}
                text={"Kalender"}
                onClick={() => navigate("calendar")}
                selected={window.location.pathname == "/app/calendar"}
            />
    ...
    return (
        <>
            <Routes>
                <Route
                    path="/app"
                    element={<App setMobileDrawerOpen={setMobileDrawerOpen} mobileDrawerOpen={mobileDrawerOpen} />}
                >
